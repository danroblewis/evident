...
struct Value {
    enum class Tag { Int, Real, Bool, Str, Enum } tag = Tag::Int;
    int64_t i = 0;
    double r = 0.0;
    bool b = false;
    std::string s;  // Str value, or Enum variant name
    ...
    // Matches the Rust CLI's `format_value`: strings quoted, others bare.
