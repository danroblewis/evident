...
sits on top. (The "no hardcoded `stdlib/<name>.ev` or
`packages/<name>.ev` path literals" sub-rule of "no library bridges"
is now mechanically enforced by AP-013; AP-001 covers the matching
Rust-type form.)
