...
/// load-time pass (desugar, inject, …) runs. Exposed for equivalence
/// tests (e.g. `runtime/tests/desugar_equivalence.rs`) that need the
/// pre-desugar schemas to feed competing pass implementations and compare.
