//! Equation translators for compound values: seq-literal / cons-chain / set-lit
//! equalities, whole-seq equality, index-assignment, and the composite
//! build/bind helpers that move data between env bindings and Z3 datatype values.
...
pub(super) fn expr_to_const_value(e: &Expr, env: &HashMap<String, Var>) -> Option<Value> {
    match e {
