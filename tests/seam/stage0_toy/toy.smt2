...
;; -- spliced from lexkind.out.smt2 [lk_=lxa_] --
(declare-fun lxa_cls () Result)
(declare-fun lxa_ka () Int)
(assert (= lxa_ka (ite ((_ is IntResult) lxa_cls) 2 0)))
(declare-fun lxa_kb () Int)
(assert (= lxa_kb (ite ((_ is RealResult) lxa_cls) 3 lxa_ka)))
(declare-fun lxa_kind () Int)
(assert (= lxa_kind (ite ((_ is StringResult) lxa_cls) 1 lxa_kb)))
(declare-fun lxa_sentinel () Int)
(assert (= lxa_sentinel 42))
;; -- spliced from lexkind.out.smt2 [lk_=lxb_] --
(declare-fun lxb_cls () Result)
(declare-fun lxb_ka () Int)
(assert (= lxb_ka (ite ((_ is IntResult) lxb_cls) 2 0)))
(declare-fun lxb_kb () Int)
(assert (= lxb_kb (ite ((_ is RealResult) lxb_cls) 3 lxb_ka)))
(declare-fun lxb_kind () Int)
(assert (= lxb_kind (ite ((_ is StringResult) lxb_cls) 1 lxb_kb)))
(declare-fun lxb_sentinel () Int)
(assert (= lxb_sentinel 42))
;; -- spliced from lexkind.out.smt2 [lk_=lxc_] --
(declare-fun lxc_cls () Result)
(declare-fun lxc_ka () Int)
(assert (= lxc_ka (ite ((_ is IntResult) lxc_cls) 2 0)))
(declare-fun lxc_kb () Int)
(assert (= lxc_kb (ite ((_ is RealResult) lxc_cls) 3 lxc_ka)))
(declare-fun lxc_kind () Int)
(assert (= lxc_kind (ite ((_ is StringResult) lxc_cls) 1 lxc_kb)))
(declare-fun lxc_sentinel () Int)
(assert (= lxc_sentinel 42))
;; -- spliced from parsedispatch.out.smt2 [pd_=pd_ pw_=pw_] --
